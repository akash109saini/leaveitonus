...
CREATE TABLE IF NOT EXISTS `quotations` (
  ...
  `service_deliverables` JSON DEFAULT NULL,
  `team_title` VARCHAR(255) DEFAULT '3. Dedicated Team & Account Management',
...
INSERT INTO `quotation_line_items` (
  ...
  'Full-funnel digital marketing, social media growth, campus video production & dedicated management team for Springfield School, Moradabad (8–10 Reels, 5–6 Creatives, Meta Ads, Scheduled Shoots & Dedicated Account Manager)',
